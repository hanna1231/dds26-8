...
class StockServiceServicer(StockServiceServicerBase):
    ...
    async def ReserveStock(self, request, context):
        ...
        while True:
            ...
            new_stock = item_entry.stock - request.quantity
            if new_stock < 0:
                ...
                if cached_bytes:
                    ...
                    if cached_str not in ("__PROCESSING__",):
                        try:
                            ...
                            return StockResponse(success=cached["success"],
            ...
            result = await self.db.eval(
                ...
                str(request.quantity), new_entry, str(item_entry.stock),
                "30", "86400", entry
            )
            ...
            try:
                ...
                return StockResponse(success=False, error_message="internal error")
